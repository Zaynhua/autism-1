...
import com.zl.autism.model.response.UserPageResult;
...
@Controller
@RequestMapping("/user")
@Api(value="restful",description="用户模块")
public class UserController {
    ...
    @ApiResponses({@ApiResponse(code=ResponseMessage.SUCCESS_CODE,message=ResponseMessage.UPDATE_SUCCESS_MSG,response=IDResult.class),
